...
# <<< BUG FIX: Corrected httpx.AsyncClient call >>>
async def get_bin_details(bin_number):
    default_response = {"bin": bin_number, "scheme": "N/A", "type": "N/A", "brand": "N/A", "bank_name": "N/A", "country_name": "N/A", "country_emoji": "🏳️"}
    ...
    try:
        ...
        return {**default_response, "error": "Lookup failed"}
...
async def chk_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        status_emoji, status_text = "💥", "Unexpected Error"
...
async def mchk_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for i, cc_details in enumerate(ccs_to_check):
        ...
        try:
            ...
            status_emoji, status_text, response_display, errors = "💥", "Unexpected Error", str(e), errors + 1
